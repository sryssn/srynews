...
export default function Kesehatan() {
    ...
    useEffect(function () {
        document.title = 'Kesehatan';
        async function getArticles() {
            const request = await fetch('https://newsapi.org/v2/top-headlines?country=id&category=health&apiKey=89b7e6e201254e0693855f267536386e');
    ...
    return (
        <section className="container">
            <h2 className="my-3">Kesehatan</h2>
            {loading ? (
