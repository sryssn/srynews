...
export default function Sains() {
    ...
    useEffect(function () {
        document.title = 'Sains';
        async function getArticles() {
            const request = await fetch('https://newsapi.org/v2/top-headlines?country=id&category=science&apiKey=89b7e6e201254e0693855f267536386e');
