...
export default function Olahraga() {
    ...
    useEffect(function () {
        document.title = 'Olahraga';
        async function getArticles() {
            const request = await fetch('https://newsapi.org/v2/top-headlines?country=id&category=sports&apiKey=89b7e6e201254e0693855f267536386e');
